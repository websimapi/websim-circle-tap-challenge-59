...
const ReplayComposition = ({ replayData, prefetchedAvatarUrl }) => {
  ...
  return /* @__PURE__ */ jsxDEV(AbsoluteFill, { style: { backgroundColor: "#1a1a2e" }, children: [
    ...
    /* @__PURE__ */ jsxDEV(AbsoluteFill, { style: { alignItems: "flex-end", justifyContent: "flex-end", padding: "20px", pointerEvents: "none" }, children: /* @__PURE__ */ jsxDEV("div", { style: {
      ...
      /* @__PURE__ */ jsxDEV(
        Img,
        {
          src: "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://challenge.on.websim.com&bgcolor=ffffff&color=000000&margin=0",
      ...
      /* @__PURE__ */ jsxDEV("div", { style: { color: "black", fontSize: "10px", fontWeight: "bold", fontFamily: "Arial", textAlign: "center" }, children: "PLAY NOW" }, void 0, false, {
        fileName: "<stdin>",
        lineNumber: 408,
        columnNumber: 21
      })
